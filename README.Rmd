...
Finally, you can ask for the evolution of measures according to a moving threshold if you provide the vector of p-values (by default, detected elements are on the left of the threshold).
