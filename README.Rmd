...
<!-- badges: start -->
[![packageversion](https://img.shields.io/badge/version-`r version`-orange.svg)](https://github.com/abichat/evabic/)
...
You can install **evabic** from CRAN using `install.packages("evabic")`. Alternatively you can grab the development version from [GitHub](https://github.com//abichat/evabic/) with:
