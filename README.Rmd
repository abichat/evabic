...
Finally, you can ask one row of measures per threshold if you provide the vector of p-values 
(by default, detected elements are on the left of the threshold).
