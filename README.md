...
[![Last-changedate](https://img.shields.io/badge/last%20change-2019--11--11-yellowgreen.svg)](/commits/master)
<!-- badges: end -->

The goal of **evabic** is to **eva**luate **bi**nary **c**lassifiers by
specifying what is detected as true and what is actually true. It has no
dependancies.
...
Consider `X1`, `X2` and `X3`, `Y` a variable predicted by this three
variables, and 4 more conditionally independent variables.
...
Singles measures are available with `ebc_*()` functions.
    ...
    #> [1] 0.6666667
    ebc_ACC(detected = detected_var, true = predictors, m = 7)
    #> [1] 0.8571429
